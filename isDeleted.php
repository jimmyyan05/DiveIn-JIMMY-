                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($activitys as $activity): ?>
                            <tr>
                                ...
                                <td>
                                    <form action="doRestore.php" method="post">
                                        <input type="hidden" name="activityID" value="<?= $activity['id'] ?>">
                                        <button title="復原" type="submit" class="btn btn-primary" name="deleted" value="0"><i class="fa-fw fa-solid fa-trash-can-arrow-up"></i></button>
                                    </form>
                                </td>
                                <td>
                                    <input type="hidden" name="activityID" value="<?= $activity['id'] ?>">
